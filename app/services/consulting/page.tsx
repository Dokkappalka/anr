  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.pageBlock}>
        ...
        <p className={styles.paragraph}>
          Ассоциация "Налоги России" оказывает услуги по проведению Due
          Diligence с целью получить полную информацию о приобретаемом бизнесе и
          иных планируемых вложениях, оценить риски, которые могут возникнуть
          после приобретения, соотвественно, принять взвешенное решение о
          целесообразности сделки и определить ее реальную цену.
        </p>
      </div>
      <div className={styles.pageBlock}>
